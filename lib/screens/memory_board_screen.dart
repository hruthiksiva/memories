        ...
        if (existingMemory.date.year != 0) {
          showDialog(
            ...
            builder: (context) => AlertDialog(
              ...
              content: const Text('Replace today\'s memory?'),
              actions: [
                TextButton(
        ...
        children: [
          Consumer<MemoryProvider>(
            builder: (context, memoryProvider, child) {
              ...
              if (memoryProvider.errorMessage.isNotEmpty) {
                return Center(child: Text(memoryProvider.errorMessage));
              }
              return DayView(memories: memoryProvider.memories);
            },
          ),
          Consumer<MemoryProvider>(
            builder: (context, memoryProvider, child) {
              ...
              return MonthView(memories: memoryProvider.memories);
            },
          ),
          Consumer<MemoryProvider>(
            builder: (context, memoryProvider, child) {
              ...
              return YearView(memories: memoryProvider.memories);
            },
          ),
        ],
      ),
...
class DayView extends StatelessWidget {
  ...
  const DayView({super.key, required this.memories});
...
class MonthView extends StatelessWidget {
  ...
  const MonthView({super.key, required this.memories});
...
class YearView extends StatelessWidget {
  ...
  const YearView({super.key, required this.memories});
...
// Required MonthPhotosScreen for MonthView navigation
